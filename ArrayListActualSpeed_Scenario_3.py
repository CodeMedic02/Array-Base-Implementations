...
# How long does it take to add records, randomly display 1000 records, and randomly remove 1000 records from the ArrayList?
...
for i in range(1000):
    ...
    # print(my_array_list.search(Client(random_id)))
    print(my_array_list.search_sorted(Client(random_id)))
...
for i in range(1000):
    ...
    largest_id = smallest_id + numRecords
    random_id = random.randint(smallest_id, largest_id)
    my_array_list.remove(Client(random_id))
